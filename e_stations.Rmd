...
qs_lbls <- sapply(1:4,function(i) paste0("Q",i," ",scales::dollar(qs[1])," to ",scales::dollar(qs[i+1])))
...
knitr::kable(fam_prop, table.attr="class='table-condensed'")
```
  </div>
  <div class="col-sm-6 col-md-6">
```{r echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(ind_prop, table.attr="class='table-condensed'")
```
  </div>
</div>
